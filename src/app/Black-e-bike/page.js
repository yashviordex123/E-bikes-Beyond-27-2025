...
const images = {
  front: '/images/24-09-Black-Cycle-Front.png',
  back: '/images/24-09-Black-Cycle-Back.png',
  middle: '/images/24-09-Black-Cycle.png',
        ...
        <div className="container py-5">
          <div className="row align-items-start">
            ...
            <div className="col-xl-5">
              <h1 className="text-orange text-center fw-bold">Black-E-bike</h1>
              ...
              <div className="fs-4 text-center fw-bold">PRICE : $90 AUD <del className="text-muted fs-4 ms-2">$100 AUD</del></div>
