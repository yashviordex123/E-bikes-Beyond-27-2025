      ...
      <main>
        <section className="container py-5" aria-labelledby="product-title">
          <div className="row align-items-start">
            ...
            {/* Right Info */}
            <div className="col-xl-5">
              <h1 id="product-title" className="text-orange fw-bold">E-bike 10-12h</h1>
              <p className="fs-4 fw-bold">PRICE: $70 AUD <del className="text-muted fs-4 ms-2">$80 AUD</del></p>
              ...
              <article>
                ...
                <ul className="list-unstyled">
                  ...
                  <li className='mb-3'><strong>Display:</strong> Multifunctional LED display, clearly visible under sunlight.</li>
                  <li className='mb-3'>
                    <strong>Lighting:</strong>
                    <ul>
                      <li>Front high-brightness headlight with wide aperture</li>
                  ...
                  <li className='mb-3'><strong>Phone Holder:</strong> USB port 2.1A output, no power bank needed.</li>
                  <li className='mb-3'>
                    <strong>Safety System:</strong>
                    <ul>
                      <li>Smart anti-theft remote (alarm + keyless start)</li>
                  ...
                  <li className='mb-3'><strong>Battery Hours:</strong> 10-12 hrs</li>
                  <li className='mb-3'><strong>Battery Life:</strong> 48V 80A</li>
                </ul>
              </article>
                ...
                {showModal && (
                  <div className="modal fade show" style={{ display: 'block', opacity: 1 }} aria-labelledby="modal-title">
                    ...
                    <div className="modal-dialog d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 id="modal-title" className="modal-title" style={{ color: 'rgb(247, 147, 30)' }}>Social Media Links</h5>
                          <button type="button" className="btn-close" onClick={handleClose} aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                          <div className="d-flex justify-content-around">
                            <a target='_blank' rel="noopener noreferrer" href="https://www.instagram.com/beyondbikes_vic/" className="text-decoration-none text-center">
                              ...
                              <span style={{ color: 'rgb(247, 147, 30)', fontSize: '17px' }}>Instagram</span>
                            </a>
