    ...
    <>
      ...
      <main className="container py-5" itemScope itemType="https://schema.org/Product">
        <div className="row align-items-start">
          ...
          {/* Right Info Section */}
          <div className="col-xl-5">
            <h1 className="text-orange fw-bold" itemProp="name">E-bike 6-8h</h1>
            <p className="fs-4 fw-bold" itemProp="offers" itemScope itemType="https://schema.org/Offer">
            ...
            <div className="mt-3" itemProp="description">
              ...
              <ul className="list-unstyled">
                ...
                <li className='mt-3'><strong>Display:</strong> Multifunctional LED display, clearly visible under sunlight.</li>
                <li className='mt-3'><strong>Lighting:</strong>
                  <ul className="ps-3 mt-1">
                    <li>Front high-brightness headlight with wide aperture</li>
                    <li>Rear light with laser projection for night safety</li>
                  </ul>
                </li>
                <li className='mt-3'><strong>Phone Holder:</strong> USB port (2.1A output)</li>
                <li className='mt-3'><strong>Safety System:</strong>
                  <ul className="ps-3 mt-1">
                    <li>Smart anti-theft remote (alarm + keyless start)</li>
                    <li>NFC smart unlock</li>
                  </ul>
                </li>
                <li className='mt-3'><strong>Braking System:</strong> Hydraulic disc brakes</li>
                <li className='mt-3'><strong>Battery Hours:</strong> 6-8 hours</li>
                <li className='mt-3'><strong>Battery Life:</strong> 48V 50A</li>
              </ul>
            </div>
        ...
        <section className="container text-center py-4" aria-labelledby="description-title">
                  ...
                  <article>
                    <h3 style={{ color: 'rgb(247,147,30)' }} className='mt-3 mb-5'>Rental Information</h3>
                    <div className="info-cards">
                      <div className="info-card">
