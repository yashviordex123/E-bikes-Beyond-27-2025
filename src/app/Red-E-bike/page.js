...
const images = {
  front: '/images/24-09-Red-Cycle-Front.png',
  back: '/images/24-09-Red-Cycle-Back.png',
  middle: '/images/24-09-Red-Cycle-Reverse.png',
  battery:'/images/24-09-Red-Cycle-Proper.png'
};

export default function RedEbike() {
